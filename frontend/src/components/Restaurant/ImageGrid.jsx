        ...
        <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
          <div className='w-full h-2/4 relative'>
            ...
            <div className='absolute inset-0 bg-opacity-40 bg-black h-full rounded-lg'>
              <h4 className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-full text-center text-white font-semibold'>View Gallery</h4>
            </div>
          </div>
          <div className='w-full h-2/4 relative'>
            <img
            ...
            <div className='absolute inset-0 bg-opacity-40 bg-black h-full rounded-lg hover:bg-opacity-70'>
              <div className='absolute flex flex-col items-center left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 z-20 w-full text-center text-white font-semibold'>
